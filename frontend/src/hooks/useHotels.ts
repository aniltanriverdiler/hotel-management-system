...
export const useHotels = (
  ...
  useAPI(
    ...
    [params.city, params.page, params.limit]
  );
export const useHotel = (id: number) =>
  useAPI(() => hotelAPI.getById(id), [id]);
...
export const useCreateReservation = () =>
  useMutation<Record<string, unknown>, unknown>(reservationAPI.create);
export const useUpdateReservationStatus = () =>
  useMutation<{ id: number; status: string }, unknown>(({ id, status }) =>
    reservationAPI.updateStatus(id, status)
  );

// Review hooks
export const useReviewsByHotel = (hotelId: number) =>
  useAPI(() => reviewAPI.getByHotelId(hotelId), [hotelId]);
export const useCreateReview = () =>
  useMutation<Record<string, unknown>, unknown>(reviewAPI.create);
export const useUpdateReview = () =>
  useMutation<{ id: number; data: Record<string, unknown> }, unknown>(
    ({ id, data }) => reviewAPI.update(id, data)
  );
export const useDeleteReview = () =>
  useMutation<number, unknown>(reviewAPI.delete);

// Chat hooks
export const useStartDirectChat = () =>
  useMutation<number, unknown>((targetUserId: number) =>
    chatAPI.startDirectChat(targetUserId)
  );
...
export const useSendMessage = () =>
  useMutation<{ chatId: number; data: Record<string, unknown> }, unknown>(
    ({ chatId, data }) => chatAPI.sendMessage(chatId, data)
  );

// Message hooks
export const useDeleteMessage = () =>
  useMutation<number, unknown>(messageAPI.deleteMessage);

// Image hooks
export const useHotelImages = (hotelId: number) =>
  useAPI(() => imageAPI.getByHotelId(hotelId), [hotelId]);
export const useUploadMainImage = () =>
  useMutation<{ hotelId: number; formData: FormData }, unknown>(
    ({ hotelId, formData }) => imageAPI.uploadMain(hotelId, formData)
  );
export const useUploadGalleryImages = () =>
  useMutation<{ hotelId: number; formData: FormData }, unknown>(
    ({ hotelId, formData }) => imageAPI.uploadGallery(hotelId, formData)
  );
export const useDeleteMainImage = () =>
  useMutation<number, unknown>(imageAPI.deleteMain);
export const useDeleteGalleryImage = () =>
  useMutation<number, unknown>(imageAPI.deleteGallery);
